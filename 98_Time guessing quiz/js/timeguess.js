...
let soundEndflag="0";
let resultMusic=["sound/reset.mp3","sound/start.mp3","sound/stop1.mp3","sound/stop2.mp3"]
...
stop.addEventListener("click",
  function() {
    ...
    if(stopTime >= 10000 && stopTime < 11000){
      w_sound=resultMusic[3];
      soundControl("start",w_sound);
      soundEndflag="1";


      const body =document.body;
      body.classList.add('fireworks-bg');
      body.style.backgroundColor="rgba(0,0,0,0)";
    }else{
      w_sound=resultMusic[2];
      soundControl("start",w_sound);
      soundEndflag="1";
    }
  },false
...
reset.addEventListener("click",
  function() {
    ...
    const body =document.body;
    body.classList.remove('fireworks-bg');
